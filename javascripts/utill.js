    ...
    getInstance () {
        var instance = {
            ...
            */
            ...
            handleError (code, options) { // 处理报错
                console.error('[util error] message: ' + this.errors[code](options));
            }
...
// 为了这个工具以后再模块化环境中依然可以使用，需要判断一下，如果是再模块化环境，就将其暴露出去
...
// define('banner', ['util'], function (util) {
//     console.log(util)
// })
